...
WalkingInterruptLogic::WalkingInterruptLogic(
    NaoControlArchitecture* _val_ctrl_arch)
    : InterruptLogic() {
  myUtils::pretty_constructor(1, "Nao Walking Interrupt Logic");
